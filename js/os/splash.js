function showSplash() {
  ...
  <div class="flex flex-col items-center justify-center h-full">
    ...
    <form id="splash-form" class="bg-gray-300 border border-gray-500 p-4 w-96">
      ...
      <button id="splash-login" onclick="setTimeout(function(){toggleButtonActiveState('splash-login', 'Login')}, 1000);toggleButtonActiveState('splash-login', 'Logging in...');" class="bg-gray-100 border-t-2 border-l-2 border-gray-50 mr-2"><span class="px-3 py-1 border-b-2 border-r-2 border-black">Login</span></button>
    </form>
