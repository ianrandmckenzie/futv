function showSplash() {
  ...
  <div class="flex flex-col items-center justify-center h-full">
    ...
    <h1 class="text-4xl text-gray-900 font-bold mb-2">FUTV - Information Access</h1>
    ...
    <form id="splash-form" class="bg-gray-300 border border-gray-500 p-4 w-96">
      ...
      <button id="splash-login" onclick="setTimeout(function(){toggleButtonActiveState('splash-login', 'Login')}, 1000);toggleButtonActiveState('splash-login', 'Logging in...');" class="bg-gray-200 border-t-2 border-l-2 border-gray-300 mr-2"><span class="border-b-2 border-r-2 border-black block h-full w-full py-1.5 px-3">Login</span></button>
    </form>
